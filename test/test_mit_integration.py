...
class MitIntegrationTestCases(unittest.TestCase):
    ...
    def test_calculate_benford_distribution(self):
        ...
        self.assertTrue(expected_max_dev, actua_max_dev)
    ...
    def test_calculate_benford_distribution_by_candidate(self):
        ...
        self.assertEqual(expected_deviations, actual_deviations)
        expected_max_dev = 23
        actual_max_dev = self.benford_analysis_service.get_maximum_deviation_from_benford_distribution(actual_deviations)
        self.assertTrue(expected_max_dev, actual_max_dev)
    ...
    def test_calculate_benford_distribution_by_year(self):
        ...
        self.assertEqual(expected_deviations, actual_deviations)
        expected_max_dev = 15
        actual_max_dev = self.benford_analysis_service.get_maximum_deviation_from_benford_distribution(actual)
        self.assertTrue(expected_max_dev, actual_max_dev)
