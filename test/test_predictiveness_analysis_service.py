...
class PredictivenessAnalysisServiceTestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.mock_nationally_winning_candidates_by_year["1993"] = "Fake Candidate 2"
        self.mock_nationally_winning_candidates_by_year["1996"] = "Fake Candidate 1"

        self.mock_nationally_losing_candidates_by_year = dict()
        self.mock_nationally_losing_candidates_by_year["1993"] = "Fake Candidate 1"
        self.mock_nationally_losing_candidates_by_year["1996"] = "Fake Candidate 2"
