...
class PredictivenessAnalysisServiceTestCase(unittest.TestCase):
    def setUp(self):
        self.mock_election_result_data = [
            ...
            ElectionResult(["2001", "MO", "Fake Candidate 2", "Fake Party 2", "451", "21000000", "County 3"]),
            ElectionResult(["2001", "MO", "Fake Candidate 2", "Fake Party 2", "6900", "21000000", "County 1"]),
            ElectionResult(["2001", "MO", "Fake Candidate 1", "Fake Party 1", "6900", "21000000", "County 2"]),
            ...
            ElectionResult(["2005", "FK", "Fake Candidate 2", "Fake Party 2", "421", "22000000", "County 3"]),
            ElectionResult(["2005", "FK", "Fake Candidate 1", "Fake Party 1", "1901", "22000000", "County 1"]),
    ...
    def test_get_locale_election_winner_by_year(self):
        ...
        actual_county_election_winner_by_year = self.mock_election_predictiveness_analysis_service.get_locale_election_winner_by_year(
            self.mock_election_result_data, "1997", "County 1", "FK")
        self.assertEqual(expected_county_election_winner_by_year, actual_county_election_winner_by_year)

        expected_county_election_winner_by_year = "Fake Candidate 1"
        actual_county_election_winner_by_year = self.mock_election_predictiveness_analysis_service.get_locale_election_winner_by_year(
            self.mock_election_result_data, "2001", "County 2", "MO")
        self.assertEqual(expected_county_election_winner_by_year, actual_county_election_winner_by_year)

        expected_county_election_winner_by_year = "Fake Candidate 2"
        actual_county_election_winner_by_year = self.mock_election_predictiveness_analysis_service.get_locale_election_winner_by_year(
            self.mock_election_result_data, "2005", "County 3", "FK")
        self.assertEqual(expected_county_election_winner_by_year, actual_county_election_winner_by_year)
    ...
    def test_get_prediction_rate_by_county(self):
        ...
        actual_prediction_rate_by_county = self.mock_election_predictiveness_analysis_service.get_prediction_rate_by_county(self.mock_election_result_data)
