...
class PredictionServiceTestCases(unittest.TestCase):
    def setUp(self):
        ...
        self.prediction_service = PredictionService(self.election_history_service)
    ...
    def test_find_locales_with_prediction_rate_above(self):
        ...
        actual = self.prediction_service.find_locales_with_prediction_rate_above(self.mock_prediction_rate_by_locale, 0.0)
        self.assertEqual(expected, actual)

        expected = ["County 1,FK", "County 2,FK", "County 4,FK"]
        actual = self.prediction_service.find_locales_with_prediction_rate_above(self.mock_prediction_rate_by_locale, 0.5)
        self.assertEqual(expected, actual)

        expected = ["County 1,FK"]
        actual = self.prediction_service.find_locales_with_prediction_rate_above(self.mock_prediction_rate_by_locale, 1.0)
        self.assertEqual(expected, actual)

    def test_find_locales_with_prediction_rate_below(self):
        expected = ["County 3,FK"]
        actual = self.prediction_service.find_locales_with_prediction_rate_below(self.mock_prediction_rate_by_locale, 0.0)
        self.assertEqual(expected, actual)

        expected = ["County 3,FK", "County 5,FK", "County 6,FK"]
        actual = self.prediction_service.find_locales_with_prediction_rate_below(self.mock_prediction_rate_by_locale, 0.5)
        self.assertEqual(expected, actual)

        expected = ["County 1,FK", "County 2,FK", "County 3,FK", "County 4,FK", "County 5,FK", "County 6,FK"]
        actual = self.prediction_service.find_locales_with_prediction_rate_below(self.mock_prediction_rate_by_locale, 1.0)
        self.assertEqual(expected, actual)
    ...
    def test_get_locale_prediction_ranking(self):
        ...
        actual = self.prediction_service.get_national_level_prediction_ranking_by_locale()
        self.assertEqual(expected, actual)
    ...
    def test_get_prediction_rate_by_locale(self):
        ...
        actual = self.prediction_service.get_national_level_prediction_rate_by_locale()
        self.assertEqual(expected, actual)
    ...
    def test_sum_correct_predictions_by_locale(self):
        ...
        actual = self.prediction_service.sum_national_level_correct_predictions_by_locale()
        self.assertEqual(expected, actual)
