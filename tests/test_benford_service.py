...
class BenfordServiceTestCases(unittest.TestCase):
    def setUp(self):
        ...
        self.benford_service = BenfordService(self.election_result_service)

    def test_get_maximum_deviation_from_benford_distribution(self):
        given_distribution = self.benford_service.first_digit_benford_distribution
        expected = 0
        actual = self.benford_service.get_maximum_deviation_from_benford_distribution(given_distribution)
    ...
    def test_calculate_deviation_from_benford_distribution(self):
        ...
        actual = self.benford_service.calculate_deviation_from_benford_distribution(given_distribution)
        self.assertEqual(expected, actual)
    ...
    def test_calculate_benford_distribution(self):
        ...
        actual = self.benford_service.calculate_benford_distribution(self.election_result_service.get_election_results())
        self.assertEqual(expected, actual)

        expected = [4, 4, 24, 0, 8, 12, 0, 0, 0, 48]
        actual = self.benford_service.calculate_benford_distribution(self.election_result_service.get_election_results(), 1)
        self.assertEqual(expected, actual)
    ...
    def test_calculate_benford_distribution_by_year(self):
        ...
        actual = self.benford_service.calculate_benford_distribution(self.election_result_service.get_election_results(year_filter="1993"))
        self.assertEqual(expected, actual)

        # year_1997_leading_digit_occurrences = [0, 3, 0, 0, 1, 0, 1, 0, 0, 1]
        expected = [0, 50.00, 0, 0, 16.67, 0, 16.67, 0, 0, 16.67]
        actual = self.benford_service.calculate_benford_distribution(self.election_result_service.get_election_results(year_filter="1997"))
        self.assertEqual(expected, actual)

        # year_2001_leading_digit_occurrences = [0, 1, 0, 0, 2, 0, 3, 0, 0, 0]
        expected = [0, 16.67, 0, 0, 33.33, 0, 50.00, 0, 0, 0]
        actual = self.benford_service.calculate_benford_distribution(self.election_result_service.get_election_results(year_filter="2001"))
        self.assertEqual(expected, actual)

        # year_2005_leading_digit_occurrences = [0, 3, 0, 0, 1, 0, 1, 0, 0, 1]
        expected = [0, 50.00, 0, 0, 16.67, 0, 16.67, 0, 0, 16.67]
        actual = self.benford_service.calculate_benford_distribution(self.election_result_service.get_election_results(year_filter="2005"))
        self.assertEqual(expected, actual)
    ...
    def test_calculate_benford_distribution_by_locality(self):
        ...
        actual = self.benford_service.calculate_benford_distribution(self.election_result_service.get_election_results(county_filter="County 1", state_filter="MO"))
        self.assertEqual(expected, actual)

        # county2_mo_leading_digit_occurrences = [0, 0, 0, 0, 2, 0, 2, 0, 0, 0]
        expected = [0, 0, 0, 0, 50.00, 0, 50.00, 0, 0, 0]
        actual = self.benford_service.calculate_benford_distribution(self.election_result_service.get_election_results(county_filter="County 2", state_filter="MO"))
        self.assertEqual(expected, actual)

        # county3_mo_leading_digit_occurrences = [0, 0, 0, 0, 2, 0, 2, 1, 0, 0]
        expected = [0, 0, 0, 0, 40.00, 0, 40.00, 20.00, 0, 0]
        actual = self.benford_service.calculate_benford_distribution(self.election_result_service.get_election_results(county_filter="County 3", state_filter="MO"))
        self.assertEqual(expected, actual)

        # county1_fk_leading_digit_occurrences = [0, 4, 0, 0, 0, 0, 0, 0, 0, 0]
        expected = [0, 100.00, 0, 0, 0, 0, 0, 0, 0, 0]
        actual = self.benford_service.calculate_benford_distribution(self.election_result_service.get_election_results(county_filter="County 1", state_filter="FK"))
        self.assertEqual(expected, actual)

        # county2_fk_leading_digit_occurrences = [0, 2, 0, 0, 0, 0, 0, 0, 0, 2]
        expected = [0, 50.00, 0, 0, 0, 0, 0, 0, 0, 50.00]
        actual = self.benford_service.calculate_benford_distribution(self.election_result_service.get_election_results(county_filter="County 2", state_filter="FK"))
        self.assertEqual(expected, actual)

        # county3_fk_leading_digit_occurrences = [0, 0, 0, 0, 2, 0, 2, 0, 0, 0]
        expected = [0, 0, 0, 0, 50.00, 0, 50.00, 0, 0, 0]
        actual = self.benford_service.calculate_benford_distribution(self.election_result_service.get_election_results(county_filter="County 3", state_filter="FK"))
        self.assertEqual(expected, actual)
    ...
    def test_calculate_benford_distribution_by_candidate(self):
        ...
        actual = self.benford_service.calculate_benford_distribution(self.election_result_service.get_election_results(candidate_filter="Fake Candidate 1"))
        self.assertEqual(expected, actual)

        # candidate_2_leading_digit_occurrences = [0, 4, 0, 0, 0, 0, 8, 0, 0, 0]
        expected = [0, 33.33, 0, 0, 0, 0, 66.67, 0, 0, 0]
        actual = self.benford_service.calculate_benford_distribution(self.election_result_service.get_election_results(candidate_filter="Fake Candidate 2"))
        self.assertEqual(expected, actual)

    def test_calculate_benford_distribution_by_party(self):
        # democrat_leading_digit_occurrences = [0, 4, 0, 0, 6, 0, 0, 0, 0, 2]
        expected = [0, 33.33, 0, 0, 50, 0, 0, 0, 0, 16.67]
        actual = self.benford_service.calculate_benford_distribution(self.election_result_service.get_election_results(party_filter="Democrat"))
        self.assertEqual(expected, actual)
        ...
        actual = self.benford_service.calculate_benford_distribution(self.election_result_service.get_election_results(party_filter="Republican"))
        self.assertEqual(expected, actual)
