class MitIntegrationByYearTestCases(unittest.TestCase):
    ...
    def test_calculate_benford_distribution_by_year_2000(self):
        ...
        actual_distribution = self.benford_service.calculate_benford_distribution(self.election_result_service.get_election_results(year_filter="2000"))
    ...
    def test_calculate_benford_distribution_by_year_2004(self):
        ...
        actual_distribution = self.benford_service.calculate_benford_distribution(self.election_result_service.get_election_results(year_filter="2004"))
        self.assertEqual(expected_distribution, actual_distribution)
    ...
    def test_calculate_benford_distribution_by_year_2008(self):
        ...
        actual_distribution = self.benford_service.calculate_benford_distribution(self.election_result_service.get_election_results(year_filter="2008"))
        self.assertEqual(expected_distribution, actual_distribution)
    ...
    def test_calculate_benford_distribution_by_year_2012(self):
        ...
        actual_distribution = self.benford_service.calculate_benford_distribution(self.election_result_service.get_election_results(year_filter="2012"))
        self.assertEqual(expected_distribution, actual_distribution)
    ...
    def test_calculate_benford_distribution_by_year_2016(self):
        ...
        actual_distribution = self.benford_service.calculate_benford_distribution(self.election_result_service.get_election_results(year_filter="2016"))
        self.assertEqual(expected_distribution, actual_distribution)
    ...
    def test_calculate_benford_distribution_by_year_2020(self):
        ...
        actual_distribution = self.benford_service.calculate_benford_distribution(self.election_result_service.get_election_results(year_filter="2020"))
        self.assertEqual(expected_distribution, actual_distribution)
