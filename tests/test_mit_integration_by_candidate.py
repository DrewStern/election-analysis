class MitIntegrationByCandidateTestCases(unittest.TestCase):
    ...
    def test_calculate_benford_distribution_by_candidate_AlGore(self):
        ...
        actual_distribution = self.benford_analysis_service.calculate_benford_distribution(
        ...
        actual_deviations = self.benford_analysis_service.calculate_deviation_from_benford_distribution(
            actual_distribution)
        self.assertEqual(expected_deviations, actual_deviations)
        expected_max_dev = 22.83
        actual_max_dev = self.benford_analysis_service.get_maximum_deviation_from_benford_distribution(
            actual_distribution)
